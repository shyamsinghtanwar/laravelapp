                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                            ...
                            <form action="{{route('update.match')}}" method="post" name="forms-sample">
                                ...
                                <input type="hidden" name="amount" value="{{$matches->amount}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="website_user_name" value="{{$matches->website_user_name}}" class="form-control" id="website_user_name"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="website_user_password" value="{{$matches->website_user_password}}" class="form-control" id="website_user_password"
                                           placeholder="Website User Password">
                                    @if ($errors->has('website_user_password'))
                                        <p class="text-danger">{{ $errors->first('website_user_password') }}</p>
                                    @endif
                                </div>
                            </div>
