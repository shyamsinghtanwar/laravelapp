            ...
            <div class="card-body">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                            ...
                            <form action="{{route('update.updateMatchwithdrawconfirm')}}" method="post" name="forms-sample">
                                @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="username1" value="{{$matches->username}}" disabled >
                                    @if ($errors->has('username1'))
                                        <p class="text-danger">{{ $errors->first('username1') }}</p>
                                    @endif
                                </div>
                            </div>
