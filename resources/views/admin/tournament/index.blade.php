                        ...
                        <tbody>
                            @foreach($events as $k=>$mac)
                                <tr>
                                    ...
                                    <td  data-label="Website name">{{$mac->websitename}}</td>
                                    <td  data-label="Website URL">{{$mac->url}}</td>
                                    <td  data-label="Event">{{$mac->event}}</td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><span class="action_act"></span> Add Website and Events</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input class="form-control input-lg action_name" name="websitename" placeholder="Website Name" required>
                        <br>
                    </div>
                    <div class="form-group">
                        <input class="form-control input-lg action_name" name="websiteurl" placeholder="Website URL" required>
                        <br>
                    </div>
                    <div class="form-group">
                        <input class="form-control input-lg action_name" name="event" placeholder="Event Name" required>
                        <br>
                    </div>
                    <div class="form-group">
                        <textarea id="discount" name="discount" rows="4" cols="30">Detail of Discount</textarea>
                        <br>
                    </div>

                    <div class="form-group">
                        <input class="form-control input-lg action_name"  type="file"  name="website_image" placeholder="website_image" required>
                        <br>
                    </div>
     ...
     (function ($) {
         ...
         $(document).ready(function () {
             $(document).on("click", '.edit_button', function (e) {
                 ...
                 var websitename = $(this).data('websitename');
                 ...
                 $(".action_name").val(websitename);
                 $(".action_name").val(websiteurl);
                 $(".action_name").val(event);
