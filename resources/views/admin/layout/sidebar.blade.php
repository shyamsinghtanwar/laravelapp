...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"><a class="nav-link" href="{{route('admin.events')}}">Add / View Websites</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{route('admin.matches')}}">Update Amount</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="{{route('admin.approvesite')}}">Create ID Request</a></li>
                    </ul>
                </div>
            </li>
        @endif
        ...
        @if(in_array('3',$access))
            <li class="nav-item">
                <a class="nav-link" href="{{route('admin.websitemoneywithdraw')}}">
                    <span class="menu-title">Withdrwal Request</span>
