                    ...
                    <div class="col-lg-10">
                        ...
                        <form action="{{route('register')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-element">
                                        <label for="phone"  class="font-weight-bold text-white">@lang('WhatsApp Contact Number')</label>
                                        <input type="hidden" id="track" name="country_code">

                                        <input type="tel" name="phone" id="phone" placeholder="@lang('WhatsApp Contact Number')">
                                ...
                                <div class="col-md-12">
                                    <div class="form-element">
                                        <label for="email"  class="font-weight-bold text-white">@lang('Please Check WhatsApp for Password')</label>
