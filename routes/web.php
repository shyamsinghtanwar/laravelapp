...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::middleware(['CheckStatus'])->group(function () {
        ...
        Route::get('/withdrawtranslog', 'HomeController@withdrawtrans')->name('withdrawtranslog');

        Route::get('/getid', 'HomeController@getid')->name('getid');
        Route::get('/processid', 'HomeController@processid')->name('processid');
        ...
        Route::get('/webiste-money-transfer', 'HomeController@websitemoneyadd')->name('website-money-transfer');
        Route::post('/website-money-transfer', 'HomeController@websitemoneyaddconfirm')->name('websitemoney.transfer');


        Route::get('/webiste-money-withdraw/{id}', 'HomeController@websitemoneywithdraw')->name('website-money-withdraw');
        Route::post('/website-money-withdraw', 'HomeController@websitemoneywithdrawconfirm')->name('websitemoney.withdraw');
...
Route::group(['prefix' => $_ENV['admin'], 'namespace' => 'Admin', 'middleware' => ['auth:admin', 'CheckAdminStatus']], function () {
        ...
        Route::group(['middleware' => ['adminAuthorize:2']], function () {
            ...
            Route::get('/events/withdraw', 'ProphecyManageController@websitewithdraw')->name('admin.websitemoneywithdraw');

            Route::get('/events/approvesite', 'ProphecyManageController@closeMatches')->name('admin.approvesite');
            ...
            Route::get('/events/editid/{id}', 'ProphecyManageController@editid')->name('edit.id');
            Route::get('/events/editwithdraw/{id}', 'ProphecyManageController@editwithdraw')->name('edit.withdraw');
        });

        Route::post('/events/update', 'ProphecyManageController@updateMatch')->name('update.match');
        Route::post('/events/updateMatchwithdrawconfirm', 'ProphecyManageController@updateMatchwithdrawconfirm')->name('update.updateMatchwithdrawconfirm');
        ...
        Route::group(['middleware' => ['adminAuthorize:3']], function () {
            ...
            Route::get('/addwebsite', 'ProphecyManageController@addwebsite')->name('awaiting.winner');
...
Route::get('notification', function(){
    event(new App\Events\MyEvent('New User Regsitered'));
